...
double BehaviorPlannerFSM::get_look_ahead_distance(const State& ego_state) {
  ...
  //using planning params-> set the lookahead distace as the total distance travelable
  //given lookahead_time current_v and max_confort_acceleration
  //d=v*t+0.5*a*t^2
  auto look_ahead_distance = velocity_mag*_lookahead_time +
    0.5*_max_accel*_lookahead_time*_lookahead_time;
